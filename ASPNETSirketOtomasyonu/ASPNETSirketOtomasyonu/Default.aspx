...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--   <br />
    <div>
        <b>Lorem Ipsum Nedir?</b>
        <br />
        Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinle<script src="Scripts/jquery-3.4.1.min.js"></script>rdir. Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca varlığını sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye de sıçramıştır. 1960'larda Lorem Ipsum pasajları da içeren Letraset yapraklarının yayınlanması ile ve yakın zamanda Aldus PageMaker gibi Lorem Ipsum sürümleri içeren masaüstü yayıncılık yazılımları ile popüler olmuştur.
          <br />
        <br />
        <b>Neden Kullanırız?</b>
        <br />
        <br />
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item active">
                            ...
                            <img src="Images/resim8.jpg" alt="First slide" style="width:100%;height:100%" />
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <br>
                                    <h3>En düşük ve en yüksek maaş bilgileri</h3>
                                    <br>
                                </div>
                            </div>
                            <img src="Images/resim9.jpg" alt="Second slide">
                        </div>
                        ...
                        <div class="item">
                            ...
                            <img src="Images/resim10.jpg" alt="Second slide">
                        </div>
